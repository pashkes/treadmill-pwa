...
const ru: Translations = {
  ...
  manual: {
    ...
    validation: {
      ...
      distancePositive: 'Введите дистанцию больше 0 км',
      durationPositive: 'Введите длительность минимум 1 минуту',
      caloriesPositive: 'Введите калории 0 или больше',
    },
  },
  export: {
  ...
  import: {
    ...
    ready: 'Импорт готов',
    failed: 'Не удалось импортировать тренировки',
  },
  pwa: {
  ...
  account: {
    title: 'Аккаунт',
    optional: 'Аккаунт необязателен. Можно продолжать записывать тренировки оффлайн без входа.',
    unconfigured: 'Облачная синхронизация не настроена на этом устройстве.',
    email: 'Email',
    password: 'Пароль',
    signIn: 'Войти',
    ...
    authNoSession: 'Аккаунт создан, но сессия не вернулась',
    sync: {
      title: 'Синхронизация',
      synced: 'Синхронизировано',
      pending: 'Ожидают {count} изменений',
