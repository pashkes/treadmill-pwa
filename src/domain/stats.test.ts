...
const workouts: Workout[] = [
  makeWorkout({ id: 1, date: '2026-06-01', time: '08:00', seconds: 600, min: 10, km: 1, kcal: 65, steps: 1200, maxSpeed: 6 }),
  makeWorkout({ id: 2, date: '2026-06-10', time: '08:00', seconds: 1200, min: 20, km: 2, kcal: 130, steps: 2400, maxSpeed: 7 }),
  makeWorkout({ id: 3, date: '2025-06-10', time: '08:00', seconds: 1800, min: 30, km: 3, kcal: 195, steps: 3600, maxSpeed: 8 }),
  makeWorkout({ id: 4, date: '2026-06-25', time: '08:00', seconds: 2400, min: 40, km: 4, kcal: 260, steps: 4800, maxSpeed: 9 }),
];
